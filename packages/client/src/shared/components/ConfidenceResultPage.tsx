...
export default function ConfidenceResultPage() {
  ...
  const renderContent = () => {
      ...
      return (
        <>
          <p className="text-gray-700 text-lg">
            You scored your confidence to achieve your goal as 0 – you are not
            at all confident. If you would like you can click on the link below
            to change your goal and set a new SMART goal. Or simply click 'Next'
            to continue.
          </p>
          <div className="mt-6">
            <LinkButton
    ...
    return (
      <p className="text-gray-700 text-lg">
        You scored your confidence as {confidence}. Click 'Next' to continue.
      </p>
    );
  };
    ...
    <div className="flex flex-col items-center bg-orange-50 min-h-[calc(100vh-4rem)]">
      <div className="w-full bg-teal-200 p-8 text-center">
        <p className="text-teal-800 text-sm font-medium border-b border-teal-800 inline-block pb-1">
          Confidence Ruler - Already have a goal
        </p>
