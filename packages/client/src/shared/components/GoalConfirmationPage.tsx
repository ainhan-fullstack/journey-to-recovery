...
export default function GoalConfirmationPage() {
      ...
      <div className="w-full max-w-md flex flex-col shadow-lg rounded-xl overflow-hidden bg-white">
        <div className="p-6 flex flex-col flex-grow">
          <div className="space-y-4 mt-8">
            ...
            <p className="text-gray-600 text-lg">
              You will be able to check-in with Journey to Recovery to report on
              your progress, and when you are ready you can set a new SMART goal
              to keep progressing towards living your best life post-stroke.
            </p>
          </div>
